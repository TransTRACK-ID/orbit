        ...
        <div v-if="step === 'template'" class="space-y-4">
          <div class="flex items-center gap-2 mb-4">
            <button
              ...
              :class="mode === 'blank' ? 'bg-surface-900 text-white dark:bg-black' : 'bg-surface-100 text-surface-600 hover:bg-surface-200 dark:bg-surface-900 dark:text-surface-400 dark:hover:bg-surface-800'"
            ...
            <button
              class="px-3 py-1.5 text-sm rounded-md transition-colors"
              :class="mode === 'template' ? 'bg-surface-900 text-white dark:bg-black' : 'bg-surface-100 text-surface-600 hover:bg-surface-200 dark:bg-surface-900 dark:text-surface-400 dark:hover:bg-surface-800'"
...
async function handleCreateBlank() {
  ...
  try {
    const project = await createProject(props.workspaceId, {
      name: blankForm.name,
      description: blankForm.description || undefined,
      color: blankForm.color,
    })
