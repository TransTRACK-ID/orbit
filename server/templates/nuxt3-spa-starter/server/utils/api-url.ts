...
/**
 * Detects if the app is running inside Orbit Live Preview.
 * Uses an explicit env flag (ORBIT_PREVIEW) instead of hostname sniffing,
 * so local development against localhost APIs still works normally.
 */
